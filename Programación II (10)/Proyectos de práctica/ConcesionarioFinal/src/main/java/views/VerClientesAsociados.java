 ...
 * @author guada
 */
public class VerClientesAsociados extends javax.swing.JFrame {
    Gerente gerente = new Gerente();
    /**
     * Creates new form VerClientesAsociados
     * @param idVendedor
     */
    public VerClientesAsociados(int idVendedor) {
        initComponents();
        mostrar(idVendedor);
    }
    
    public void mostrar(int idVendedor) {
        List<String[]> vendedores = gerente.obtenerClientesPorVendedor(idVendedor);
