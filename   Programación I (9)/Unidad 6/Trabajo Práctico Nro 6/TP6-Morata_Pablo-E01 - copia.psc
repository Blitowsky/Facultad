Algoritmo TP6_E01
	...
	///Entrada: 
	//El usuario ingresa los operandos y la operación a aplicarles, esto hasta que ingrese el "0"
	///Salida:
	//El programa entregará el resultado de la operación pedida y se cerrará al ingresar el usuario "0"

	
	Definir reset Como Caracter
	Definir resultado Como Real
	Definir menu, ope1, ope2 Como Entero
