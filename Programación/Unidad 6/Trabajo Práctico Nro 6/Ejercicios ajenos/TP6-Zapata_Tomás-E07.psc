Algoritmo NúmerosAmigos
	
	///Ejercicio 7: Escriba un programa que a través del uso de una función determine si dos números ingresados por el usuario son amigos o no.
	//Datos de entrada: 2 números.
	//Datos de salida: el programa indica si son amigos o no.
