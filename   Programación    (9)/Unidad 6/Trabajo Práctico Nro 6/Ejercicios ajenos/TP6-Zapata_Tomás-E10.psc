Algoritmo LatasDePintura
	
	///Ejercicio 10: Se desea calcular la cantidad de latas de pintura necesarias del mismo color para pintar las paredes de todas las habitaciones de una casa.
	//Datos de entrada: 6 datos en total (ancho, largo, alto, cantidad de ventanas, puertas y manos a pintar).
	//Datos de salida: superficie a pintar, minimo de cantidad de latas y de qué tamaño son, y cuánto dinero se necesita para pagar toda la pintura.
